...
app.post('/api/transcribe/assemblyai', async (req, res) => {
  try {
    ...
    console.log('AssemblyAI response:', submitData);
    
    if (submitData.error) throw new Error(submitData.error);
    if (!submitData.id) throw new Error('Transcript ID alınamadı');
